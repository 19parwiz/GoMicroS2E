...
import (
	...
	grpcAPI "github.com/19parwiz/inventory/internal/adapter/grpc"
	//httpRepo "github.com/BeksultanSE/Assignment1-inventory/internal/adapter/http"
	mongoRepo "github.com/19parwiz/inventory/internal/adapter/mongo"
	"github.com/19parwiz/inventory/internal/usecase"
	mongoConn "github.com/19parwiz/inventory/pkg/mongo"
	"log"
	"os"
	"os/signal"
	"syscall"
